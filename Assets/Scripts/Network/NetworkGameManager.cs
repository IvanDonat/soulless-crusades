...
public class NetworkGameManager : Photon.PunBehaviour 
{
    ...
    {
        Events.Clear();
        platformManager = GameObject.FindWithTag("Platform").GetComponent<PlatformManager>();
        StartCoroutine(platformManager.ProjectArcaneCircle());
